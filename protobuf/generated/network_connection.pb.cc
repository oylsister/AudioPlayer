...
static const ::_pb::EnumDescriptor* PROTOBUF_NONNULL
    file_level_enum_descriptors_network_5fconnection_2eproto[1];
static constexpr const ::_pb::ServiceDescriptor *PROTOBUF_NONNULL *PROTOBUF_NULLABLE
    file_level_service_descriptors_network_5fconnection_2eproto = nullptr;
...
const char descriptor_table_protodef_network_5fconnection_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_network_5fconnection_2eproto_deps[1] = {
        &::descriptor_table_google_2fprotobuf_2fdescriptor_2eproto,
};
static ::absl::once_flag descriptor_table_network_5fconnection_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_network_5fconnection_2eproto = {
    false,
    false,
    10016,
    descriptor_table_protodef_network_5fconnection_2eproto,
    "network_connection.proto",
    &descriptor_table_network_5fconnection_2eproto_once,
    descriptor_table_network_5fconnection_2eproto_deps,
    1,
    0,
    schemas,
    file_default_instances,
    TableStruct_network_5fconnection_2eproto::offsets,
    file_level_enum_descriptors_network_5fconnection_2eproto,
...
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL ENetworkDisconnectionReason_descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_network_5fconnection_2eproto);
  return file_level_enum_descriptors_network_5fconnection_2eproto[0];
}
PROTOBUF_CONSTINIT const uint32_t ENetworkDisconnectionReason_internal_data_[] = {
    4587520u, 96u, 65278u, 4227858432u, 1073741823u, };
...
PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 ::_pbi::ExtensionIdentifier<
        ::google::protobuf::EnumValueOptions, ::_pbi::StringTypeTraits, 12, false>
        network_connection_detail_token(kNetworkConnectionDetailTokenFieldNumber, network_connection_detail_token_default);
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_network_5fconnection_2eproto),
        ::_pbi::ExtensionSet::RegisterExtension(
            &::google::protobuf::EnumValueOptions::default_instance(), 50500, 12,
            false, false),
        ::_pbi::ExtensionSet::RegisterExtension(
            &::google::protobuf::EnumValueOptions::default_instance(), 50501, 12,
            false, false),
         ::std::false_type{});
